...
#Create sparql endpoint. For me this hasn't worked and SPARQL gives junbled results
...
#Materializing without the turtle file works faster and gives required results, using python's rdflib
./ontop materialize --mapping=data/Ontop_config/integrateX.obda --properties=data/Ontop_config/duckdb.properties -o data/duckdb_materialized_triples1.rdf --lenses=data/Ontop_config/lenses.json
